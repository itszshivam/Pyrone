...
ONE_WORDS = ["MADARCHOD", "TUJHE", "PELTA", "HU", "BAAP", "SE", "BHIR", "GYA NA", "AB TERI", "MAA", "CHODTA HU",
           ...
           "MERAA","LOURA","JAISE","ALUU","KAAA","PAKODAA","TERI","MAAA","BEHEN","GF","NANI","DADI","DIN", "RAAT","SOTEE",
           "JAGTEE","AIDS KE","PATIENT","SE CHUDWAYEGI","CHAAR","CHAWNII","GHODEE","PEEE","TUMM","MEREE","LAURE","PEE","TERI",
           "MAA","KAAA","BOOBS","DABATA HU",
           "TERI", "MAA", "KI", "CHUT", "AJA", "TERI", "MAA", "KI", "CHUT",
